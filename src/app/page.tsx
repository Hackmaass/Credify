...
export default function LandingPage() {
  ...
  return (
    <div className="oku-landing-page min-h-screen relative overflow-x-hidden text-black dark:text-white bg-[#FAF9F7] dark:bg-[#0A0A0A]">
      ...
      <header className={`fixed top-0 left-0 right-0 h-20 z-50 transition-all duration-300 flex items-center justify-center ${scrolled ? 'bg-[#FAF9F7] dark:bg-[#0A0A0A]/95 border-b border-[#E8E8E9] dark:border-white/10 shadow-sm backdrop-blur-md' : 'bg-transparent'}`}>
        <div className="w-full max-w-5xl mx-auto px-6 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-[#46474E] dark:text-gray-300">
            <Link href="#features" className="hover:text-black dark:text-white transition-colors">Explore</Link>
            <Link href="#import" className="hover:text-black dark:text-white transition-colors">Integrations</Link>
            <Link href="#team" className="hover:text-black dark:text-white transition-colors">Team</Link>
            <Link href="https://twitter.com/credify" target="_blank" className="hover:text-black dark:text-white transition-colors flex items-center gap-1">
              Twitter <ExternalLink className="w-3 h-3" />
            </Link>
            <Link href="mailto:support@credify.so" className="hover:text-black dark:text-white transition-colors">Contact</Link>
          </nav>

          {/* Right Action Buttons */}
          <div className="hidden md:flex items-center gap-6">
            <ThemeToggle className="text-[#46474E] dark:text-gray-300 hover:text-black dark:text-white dark:text-gray-300 dark:hover:text-white" />
            <Link href="/login" className="text-sm font-medium text-[#46474E] dark:text-gray-300 hover:text-black dark:text-white dark:text-gray-300 dark:hover:text-white transition-colors">
              Sign in
            </Link>
            <Link href="/login">
              <button className="bg-black dark:bg-white dark:text-black dark:text-white text-white px-5 py-2.5 rounded-full text-sm font-semibold hover:bg-neutral-800 dark:hover:bg-gray-200 transition-all shadow-xs hover:-translate-y-0.5 active:translate-y-0">
                Join
              </button>
            </Link>
          </div>
        ...
        <div className="md:w-1/2 flex flex-col items-start text-left">
          ...
          <div className="flex flex-wrap items-center gap-4 w-full sm:w-auto">
            ...
            <Link href="https://chrome.google.com/webstore" target="_blank" className="w-full sm:w-auto">
              <button className="bg-[#F3F4F4] dark:bg-[#111111] text-[#131314] dark:text-gray-200 w-full sm:w-auto px-8 py-4 rounded-full text-base font-semibold hover:bg-[#E8E8E9] transition-all">
                Install Extension
              </button>
            </Link>
          </div>
          <p className="text-sm text-[#8C8C90] dark:text-gray-400 mt-5">
            Already a member? <Link href="/login" className="text-[#46474E] dark:text-gray-300 hover:text-black dark:text-white underline transition-colors">Sign in.</Link>
          </p>
        </div>
      ...
      <section id="import" className="max-w-5xl mx-auto px-6 py-20 flex flex-col md:flex-row items-center gap-12 border-b border-[#E8E8E9] dark:border-white/10 pb-24 mb-20">
        ...
        <div className="md:w-[45%] w-full flex flex-col gap-6 relative">
          ...
          {/* Tweet 1 */}
          <div className="bg-[#F3F4F4] dark:bg-[#111111] p-6 rounded-2xl border border-[#E8E8E9] dark:border-white/10/40 max-w-md ml-auto relative md:w-[110%] z-10 shadow-xs hover:border-black/10 transition-colors">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h4 className="text-sm font-bold text-black dark:text-white leading-none">fem</h4>
                <span className="text-xs text-[#8C8C90] dark:text-gray-400">@femke</span>
              </div>
              <span className="text-xs text-[#8C8C90] dark:text-gray-400 ml-auto">Mar 23</span>
            </div>
          ...
          {/* Tweet 2 */}
          <div className="bg-[#F3F4F4] dark:bg-[#111111] p-6 rounded-2xl border border-[#E8E8E9] dark:border-white/10/40 max-w-md ml-auto md:w-[110%] md:translate-x-[10%] shadow-xs hover:border-black/10 transition-colors">
            <div className="flex items-center gap-3 mb-4">
              <img src="/images/homepage/joe.png" alt="Joe avatar" className="w-10 h-10 rounded-full border border-black/5 object-cover" />
              <div>
                <h4 className="text-sm font-bold text-black dark:text-white leading-none">Joe Russell</h4>
                <span className="text-xs text-[#8C8C90] dark:text-gray-400">@Joebob</span>
              </div>
              <span className="text-xs text-[#8C8C90] dark:text-gray-400 ml-auto">Feb 21</span>
            </div>
            <p className="text-[#131314] dark:text-gray-200 text-[15px] leading-relaxed">
        ...
        <div className="flex flex-col gap-12">
          ...
          <div className="flex flex-col md:flex-row gap-4 md:gap-8">
            <div className="md:w-[30%]">
              <h4 className="text-sm font-bold text-[#8C8C90] dark:text-gray-400 uppercase tracking-wider">Looking to switch?</h4>
            </div>
            <div className="md:w-[70%] text-left">
              <h3 className="oku-font-serif text-2xl text-black dark:text-white font-normal mb-2">Import from YouTube &amp; Github</h3>
          ...
          <div className="flex flex-col md:flex-row gap-4 md:gap-8">
            ...
            <div className="md:w-[70%] text-left">
              <h3 className="oku-font-serif text-2xl text-black dark:text-white font-normal mb-2">Retain control of your data</h3>
              <p className="text-[#46474E] dark:text-gray-300 text-base leading-relaxed">
          ...
          <div className="flex flex-col md:flex-row gap-4 md:gap-8">
            <div className="md:w-[30%]">
              <h4 className="text-sm font-bold text-[#8C8C90] dark:text-gray-400 uppercase tracking-wider">Is this sustainable?</h4>
            </div>
            <div className="md:w-[70%] text-left">
              <h3 className="oku-font-serif text-2xl text-black dark:text-white font-normal mb-2">We are member supported</h3>
              <p className="text-[#46474E] dark:text-gray-300 text-base leading-relaxed">
      ...
      <section id="team" className="max-w-5xl mx-auto px-6 pb-24 flex flex-col items-center text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-12 w-full max-w-3xl mt-6">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h4 className="font-semibold text-lg text-black dark:text-white mb-1">Yavor Punchev &amp; Fuji</h4>
            <span className="text-sm text-[#8C8C90] dark:text-gray-400">Sofia, Bulgaria</span>
          </div>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h4 className="font-semibold text-lg text-black dark:text-white mb-1">Joe Alcorn</h4>
            <span className="text-sm text-[#8C8C90] dark:text-gray-400">London, United Kingdom</span>
          </div>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h4 className="font-semibold text-lg text-black dark:text-white mb-1">Aziz Firat</h4>
            <span className="text-sm text-[#8C8C90] dark:text-gray-400">Oslo, Norway</span>
          </div>
        </div>
      </section>
      ...
      <footer className="relative bg-[#F6F6F6] dark:bg-[#050505] pt-12 overflow-hidden border-t border-[#E8E8E9] dark:border-white/10">
        ...
        <div className="max-w-5xl mx-auto px-6 py-12 relative border-t border-[#E8E8E9] dark:border-white/10 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex flex-wrap justify-center gap-6 text-[#46474E] dark:text-gray-300 font-medium text-sm z-10">
            ...
            <Link href="#import" className="hover:text-black dark:text-white transition-colors">Integrations</Link>
            <Link href="#team" className="hover:text-black dark:text-white transition-colors">Team</Link>
            <Link href="https://twitter.com/credify" target="_blank" className="hover:text-black dark:text-white transition-colors">Twitter</Link>
            <Link href="mailto:support@credify.so" className="hover:text-black dark:text-white transition-colors">Contact</Link>
          </div>
